...
INSTALLED_APPS = [
    ...
    # Debug toolbar
    'debug_toolbar',
    # Лучше именно так регистрировать своё приложение
    'women.apps.WomenConfig',  # Наше зарегистрированное приложение, которое разрешает отображаться в админ панели
    'captcha',  # Установка капчи
]
...
CACHES = {
    'default': {
        ...
        'LOCATION': os.path.join(BASE_DIR, 'Cache'),  # Путь к папке с кэшем
    }
}
